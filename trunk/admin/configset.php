...
if (isset($Submit)) {
	if (!is_writable("../settings/conf.php")) {
       ...
       $fhandle=fopen("../settings/conf.php","w+b");
...
<td class="left1"> Sphider 版本: </td>
<td ><input name="_version_nr" value="<?php print $version_nr;?>" type="hidden"> 
