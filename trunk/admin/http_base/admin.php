...
require "auth.php";
require "$include_dir/commonfuncs.php";
extract (getHttpVars());
...
<?php
      ...
      echo "<div style='margin-left:10px'>当前用户:{$_SERVER['PHP_AUTH_USER']}  登录时间:{$_SESSION['loginTime']} <a href='../../index.php' target='_bank'>搜索页面</a></div>";
?>
